...
// ── 5. Encontrar o servidor e injetar na posição correta ────
...
// Filtrar duplicatas antes de injetar
const modsNovos = [];
let ignorados = 0;
...
if (modsNovos.length === 0) {
  console.log('');
  console.log('═══════════════════════════════════════════');
  console.log('✅ Todos os mods já existem. Nada a injetar.');
  console.log('═══════════════════════════════════════════');
  // Salvar mesmo assim (sem alteração) para manter consistência
...
console.log(`   ✅ ${modsNovos.length} mod(s) injetado(s)`);
